...
class UserInterestsControllerTest < ActionController::TestCase
  ...
  test "should create user_interest" do
    assert_difference('UserInterest.count') do
      post :create, user_interest: { company_id: @user_interest.company_id, rating: @user_interest.rating, user_id: @user_interest.user_id }
    end
  ...
  test "should update user_interest" do
    patch :update, id: @user_interest, user_interest: { company_id: @user_interest.company_id, rating: @user_interest.rating, user_id: @user_interest.user_id }
    assert_redirected_to user_interest_path(assigns(:user_interest))
  end
